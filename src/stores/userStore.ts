...
export const useUserStore = defineStore('users', () => {
    ...
    return { 
        getUsers, changePassword, changeProfile, getCurrentUser, isLoading, updateUser, getActivities, revokeAllTokens, revokeToken,
        createUser, deleteUser, getAllUser, getUser
    }
})